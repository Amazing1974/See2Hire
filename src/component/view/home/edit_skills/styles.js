...
export const SkillContainer = styled(KeyboardAwareScrollView)`
    alignSelf: stretch;
`;

export const Deselect = styled.TouchableOpacity`
    width: 100%;
    alignItems: flex-end;
    padding: 5px;
`;
...
export const SkillItemContainer = styled.TouchableOpacity`
    flexDirection: row;
